...
const techOptions = {
  frontend: {
    ...
    options: [
      ...
      { id: "solidjs", label: "Solid.js", disabled: true },
      { id: "qwik", label: "Qwik", disabled: true },
      { id: "astro", label: "Astro", disabled: true },
  ...
  metaFramework: {
    ...
    options: [
      ...
      { id: "nuxtjs", label: "Nuxt.js", requires: ["vue"], disabled: true },
      { id: "sveltekit", label: "SvelteKit", requires: ["svelte"], disabled: true },
      { id: "vite", label: "Vite", disabled: true },
      { id: "none", label: "None" },
    ],
  },
  language: {
    ...
    options: [
      ...
      { id: "php", label: "PHP", disabled: true },
  ...
  styling: {
    ...
    options: [
      ...
      { id: "shadcn-ui", label: "shadcn/ui", requires: ["react"], disabled: true },
      { id: "styled-components", label: "Styled Components", requires: ["react"], disabled: true },
      { id: "chakra-ui", label: "Chakra UI", requires: ["react"], disabled: true },
      { id: "material-ui", label: "Material UI", requires: ["react"], disabled: true },
  ...
  stateManagement: {
    ...
    options: [
      ...
      { id: "redux", label: "Redux", requires: ["react"], disabled: true },
      { id: "zustand", label: "Zustand", requires: ["react"], disabled: true },
  ...
  backend: {
    ...
    options: [
      ...
      { id: "python-flask", label: "Flask", disabled: true },
      { id: "laravel", label: "Laravel" },
      { id: "spring-boot", label: "Spring Boot", disabled: true },
  ...
  testing: {
    ...
    type: "checkbox" as const,
    options: [
      { id: "jest", label: "Jest", popular: true, disabled: true },
      { id: "vitest", label: "Vitest", disabled: true },
